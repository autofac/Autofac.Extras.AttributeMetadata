...
namespace Autofac.Extras.AttributeMetadata
{
    ...
    /// <see cref="Autofac.Extras.AttributeMetadata.WithMetadataAttribute"/> allows constructor
    /// parameters to be filtered by registered metadata criteria and the
    /// <see cref="Autofac.Extras.AttributeMetadata.WithKeyAttribute"/> allows constructor
