...
public sealed class WithMetadataAttribute : ParameterFilterAttribute
{
    ...
    public override object? ResolveParameter(ParameterInfo parameter, IComponentContext context)
    {
        ...
        return hasMany
            ? _filterAllInfo.MakeGenericMethod(elementType).Invoke(null, new[] { context, Key, Value })
            : _filterOneInfo.MakeGenericMethod(elementType).Invoke(null, new[] { context, Key, Value });
    }
